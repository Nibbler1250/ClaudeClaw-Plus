...
import {
  ...
  runPendingResolver,
} from "../adapters/telegram/pending-resolver";
...
// Pending-action ack helpers live with the Bus adapter now (shared by both
// Telegram paths); re-exported so existing imports and tests keep working.
export {
  normalizeDecision,
  classifyDecision,
  ackForAlready,
